...
if (isset($_POST['register'])) {
    ...
    $status = '';
    $reg_customer->register($full_name, $email, $username, $password, $status);
}
            ...
            <div class="row">
                <div class="col-4">
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                          <a class="nav-link text-light ps-0" href="login.php">Log in</a>
                        </li>
                    </ul>
                </div>
                <div class="col-4 text-center pt-2"><p>Register to our online shop!</p></div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 offset-md-4 col-md-4 offset-lg-4 col-lg-4 offset-xl-4 col-xl-4 offset-xxl-4 col-xxl-4 text-start d-block m-auto p-xs-2 p-sm-2 p-md-0 p-lg-3 p-xl-5 p-xxl-5 my-5">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <input class="form-control mb-2 border-2" type="text" name="full_name" required><br>
                    <label for="">Email</label><br>
                    <input class="form-control mb-2 border-2" type="email" name="email" required><br>
                    <label for="">User name</label><br>
                    <input class="form-control mb-2 border-2" type="text" name="user_name" required><br>
                    ...
                    <input class="btn btn-outline-primary mt-1" type="submit" value="Register" name="register">
                </form>
            </div>
        </div>
    </div>
